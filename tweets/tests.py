...
class TweetTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.userb = User.objects.create_user(username="abc2", password="somepassword2")
        Tweet.objects.create(content="my 1 tweet", user=self.user)
        Tweet.objects.create(content="my 2 tweet", user=self.user)
        Tweet.objects.create(content="my 3 tweet", user=self.userb)
    ...
    def test_tweet_create_api_view(self):
        request_data = {"contnet": "This is my test tweet"}
        client = self.get_client()
